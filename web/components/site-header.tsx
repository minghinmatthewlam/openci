...
function TerminalIcon(): React.ReactNode {
  return (
    <svg
      width="20"
      height="20"
    ...
    <header className="site-header">
      <div className="header-inner">
        <Link href="/" className="brand-row" draggable={false}>
          ...
          <span className="font-semibold text-white tracking-tight text-lg">OpenCI</span>
        </Link>
        ...
        <nav className="top-nav">
          ...
          <a
            href="https://github.com/minghinmatthewlam/openci"
            target="_blank"
